...
// import { OnboardingWizard } from "@/components/app/OnboardingWizard" // ⚡ REMOVED: No longer needed
...
export function Dashboard({ user, household }: { user: User, household: Household & { currency?: string, country?: string, avatar_url?: string } }) {
    ...
    useEffect(() => {
        ...
        // ❌ REMOVED: if (!user.user_metadata?.onboarding_complete) setShowOnboarding(true);
    ...
    // ❌ REMOVED: handleOnboardingComplete is no longer necessary here
    ...
    return (
        <SidebarLayout user={user} household={household} memberCount={memberCount} activeTab={activeTab} setActiveTab={setActiveTab}>
            <div className="w-full pb-24 relative">
                ...
                {/* ❌ REMOVED: OnboardingWizard is no longer called from Dashboard */}
